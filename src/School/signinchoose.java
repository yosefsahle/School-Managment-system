 ...
 */
public class signinchoose extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("About This APP");
    ...
    public static void main(String args[]) {
        signinchoose B = new signinchoose();
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(signinchoose.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new signinchoose().setVisible(true);
            }
        });
    }
