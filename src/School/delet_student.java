...
public class delet_student extends javax.swing.JFrame {
    classchanger A = new classchanger();
    
    public void delet(){
    String Q = TDN.getText();
        
        try{
        File D = new File("c:\\A\\SU\\"+Q+".txt");
        File R = new File("c:\\A\\SG\\"+Q+".txt");
        if (D.exists()){
        D.delete();
        R.delete();
        JOptionPane.showMessageDialog(rootPane, "File Deleted Succesfuly");
        }
        else{
        JOptionPane.showMessageDialog(rootPane, "There is no Student in this Name");
        }
        }
        catch(Exception e){
    ...
    private void initComponents() {
        ...
        TDN = new javax.swing.JTextField();
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(TDN, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(145, 145, 145)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delet_student().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField TDN;
